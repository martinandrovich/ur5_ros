...
namespace ur5
{
	inline constexpr auto    EXEC_FREQ             = 1000.0; // [Hz]
	inline constexpr auto    EXEC_DT               = 1./EXEC_FREQ; // [s]
	inline const std::string COMMAND_TOPIC_JNT_POS = "/ur5_joint_position_controller/command";
	// inline const std::string COMMAND_TOPIC_CAR_POS = "/ur5_joint_position_controller/command";
