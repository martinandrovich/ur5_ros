...
namespace ur5_controllers
{
	...
	CartesianPoseController::init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle& nh)
	{
		...
		sub_command = nh.subscribe<ur5_msgs::PoseTwist>("command", 1, &CartesianPoseController::callback_command, this);
	...
	void
	CartesianPoseController::callback_command(const ur5_msgs::PoseTwistConstPtr& msg)
	{
